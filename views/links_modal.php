    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="rtr-btn rtr-btn-default" data-dismiss="modal">Close</button>      
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<div class="modal bs-modal fade modalexternallinks" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><div aria-hidden="true">&times;</div></button>
                <h4 class="modal-title rtr-fs-4 rtr-m-0">External Links</h4>
            </div>
            <div class="modal-body">
                <?php
                if (!isset($analys->links->internal_links) || count($analys->links->internal_links) == 0) {
...
<div class="modal bs-modal fade modalbrokenlinks" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><div aria-hidden="true">&times;</div></button>
                <h4 class="modal-title rtr-fs-4 rtr-m-0">Broken Links</h4>
            </div>
            <div class="modal-body">
                <?php
...
<div class="modal bs-modal fade modaltitlelinks" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><div aria-hidden="true">&times;</div></button>
                <h4 class="modal-title rtr-fs-4 rtr-m-0">Links Without Title Attributes</h4>
            </div>
            <div class="modal-body">
                <?php
...
<div class="modal bs-modal fade modalrellinks" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><div aria-hidden="true">&times;</div></button>
                <h4 class="modal-title rtr-fs-4 rtr-m-0">Links Without Rel Attributes</h4>
            </div>
            <div class="modal-body">
                <?php
...
<div class="modal bs-modal fade modalallimages" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><div aria-hidden="true">&times;</div></button>
                <h4 class="modal-title rtr-fs-4 rtr-m-0">All Images</h4>
            </div>
            <div class="modal-body">
                <?php
...
<div class="modal bs-modal fade modalgrouping" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><div aria-hidden="true">&times;</div></button>
                <h4 class="modal-title rtr-fs-4 rtr-m-0">Keyword Group</h4>
            </div>
            ...
            <div class="modal-footer">
                <a href="javascript:;" class="rtr-btn rtr-btn-primary addkeywordintool addbtnkeyword" >Add</a>
                <button type="button" class="rtr-btn rtr-btn-default" data-dismiss="modal">Close</button>      
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<div class="modal bs-modal fade modaladdlanding" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><div aria-hidden="true">&times;</div></button>
                <h4 class="modal-title rtr-fs-4 rtr-m-0">Add Page To Landing Or Conversion URLs</h4>
            </div>
            <div class="modal-body groupdv">                
                <?php if ($openpop == 1) {
                    ?>
                    <div class="rtr-alert rtr-alert-success"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button> <?php echo $ms; ?></div>
                    <?php }
                ?>
                ...
                if ($isinconv == 0 && $isinland == 0) {
                    ?>
                    <div><a href='javascript:;' class="rtr-btn rtr-btn-primary pagetolanding">Add To Landing Page URLs </a></div>
                    <div class="centrgrpdiv"><span>OR</span></div>
                    <div><a href='javascript:;' class="rtr-btn rtr-btn-primary pagetothank">Add To Thank You Page URLs</a></div>
                    <?php
                } elseif ($isinconv == 1 && $isinland == 0) {
                    if ($openpop == 0) {
                        ?>   
                        <div class="rtr-alert rtr-alert-danger">URL Already Added As Thank You Page</div>
                    <?php } ?>
                    <div><a href='javascript:;' class="rtr-btn rtr-btn-primary pagetothankrm">Click Here To Remove</a></div>
                    <?php
                } elseif ($isinconv == 0 && $isinland == 1) {
                    if ($openpop == 0) {
                        ?>   
                        <div class="rtr-alert rtr-alert-danger">URL Already Added As Landing Page</div>
                    <?php } ?>
                    <div><a href='javascript:;' class="rtr-btn rtr-btn-primary pagetolandingrm">Click Here To Remove</a></div>
                    <?php
                }
                ?>                                                
            </div>
